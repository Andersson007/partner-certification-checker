---
name: commit
description: "This skill should be used when the user asks to 'commit', 'create a commit', or 'git commit'. It creates conventional commits scoped to this repo's components."
---
...
Examples:
```
feat(certification): add collection-deps input to install collection dependencies

Assisted-by: Claude Sonnet 4.6
```

```
feat(certification-reusable)!: drop support for ansible-core <= 2.16
