...
5. Update the release part in the [calling workflow](.github/workflows/certification.yml) if needed, for exampe, `@v1` -> `v2` so that new users copy its latest version.
